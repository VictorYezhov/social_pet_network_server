...
public interface MessageDAO extends JpaRepository<Message, Long> {
    ...
    @Query(value = "select count(*) from message where friends_id =:id and user_to =:uId and is_read = false ",nativeQuery = true)
    Integer countUnreaded(@Param("id")Long id, @Param("uId") Long uId);
}
